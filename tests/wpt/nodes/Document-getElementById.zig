...
test "getElementById with null-like string" {
    ...
    _ = try root.prototype.appendChild(&element.prototype);
...
test "getElementById with script-inserted element" {
    ...
    _ = try root.prototype.appendChild(&test_elem.prototype);
    ...
    _ = try root.prototype.removeChild(&test_elem.prototype);
...
test "getElementById only finds elements in document" {
    ...
    _ = try root.prototype.appendChild(&e.prototype);
...
test "getElementById returns first element in tree order" {
    ...
    _ = try root.prototype.appendChild(&element4.prototype);
    ...
    _ = try root.prototype.removeChild(&target.prototype);
...
test "getElementById with element not in document tree" {
    ...
    _ = try parent.prototype.appendChild(&s.prototype);
...
test "getElementById with multiple nested elements" {
    ...
    _ = try outer.prototype.appendChild(&middle.prototype);

    const inner = try doc.createElement("inner");
    try inner.setAttribute("id", "inner");
    _ = try middle.prototype.appendChild(&inner.prototype);
