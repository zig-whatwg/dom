...
pub fn build(b: *std.Build) void {
    ...
    const comprehensive_demo_step = b.step("run-comprehensive-demo", "Run comprehensive feature demo");
    ...
    const advanced_demo = b.addExecutable(.{
        .name = "advanced_demo",
        .root_module = b.createModule(.{
            .root_source_file = b.path("examples/advanced_features_demo.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "dom", .module = mod },
    ...
    const run_advanced_demo = b.addRunArtifact(advanced_demo);
    const advanced_demo_step = b.step("run-advanced-demo", "Run advanced features demo");
    advanced_demo_step.dependOn(&run_advanced_demo.step);

    // MutationObserver Demo
    const mutation_demo = b.addExecutable(.{
        .name = "mutation_demo",
        .root_module = b.createModule(.{
            .root_source_file = b.path("examples/mutation_observer_demo.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "dom", .module = mod },
    ...
    b.installArtifact(mutation_demo);

    const run_mutation_demo = b.addRunArtifact(mutation_demo);
    const mutation_demo_step = b.step("run-mutation-demo", "Run MutationObserver demo");
    mutation_demo_step.dependOn(&run_mutation_demo.step);

    // Document Types Demo
    const document_types_demo = b.addExecutable(.{
        .name = "document_types_demo",
        .root_module = b.createModule(.{
            .root_source_file = b.path("examples/document_types_demo.zig"),
            .target = target,
            .optimize = optimize,
            .imports = &.{
                .{ .name = "dom", .module = mod },
    ...
    b.installArtifact(document_types_demo);

    const run_document_types_demo = b.addRunArtifact(document_types_demo);
