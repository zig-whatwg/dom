...
//! - **§2.3 Legacy Event Initializers**: https://dom.spec.whatwg.org/#legacy-event-initializers
//! - **§2.10 Dispatching Events**: https://dom.spec.whatwg.org/#dispatching-events
//!
//! ## MDN Documentation
//!
...
//! - All methods match WebIDL signatures (undefined → void, boolean → bool)
